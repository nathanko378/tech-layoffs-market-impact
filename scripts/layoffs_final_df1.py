...
final_df_layoff_num = top_with_ticker_num.loc[top_with_ticker_num.groupby("Ticker")["# Laid Off"].idxmax()].sort_values(by="# Laid Off", ascending=False).head(50)
final_df_layoff_percent = top_with_ticker_percent.loc[top_with_ticker_percent.groupby("Ticker")["%"].idxmax()].sort_values(by="%", ascending=False).head(50)
